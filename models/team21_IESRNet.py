...
class RRFB_2conv_nores_rep1(nn.Module):
    def __init__(self,
                 in_channels,
                 mid_channels=None,
                 out_channels=None,
                 esa_channels=16):
        super(RRFB_2conv_nores_rep1, self).__init__()
...
class IESRNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 feature_channels=32,
                 upscale=4):
        super(IESRNet, self).__init__()


        self.conv_1 = Conv3XC(in_channels, feature_channels, gain1=2, s=1)

        self.block_1 = RRFB_rep1(feature_channels, mid_channels=32)
        self.block_2 = RRFB_2conv_nores_rep1(feature_channels, mid_channels=32)
        self.block_3 = RRFB_2conv_nores_rep1(feature_channels, mid_channels=32)
